...
const ICONS = {
  ...
  questionBank: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
  blueprint:    'M3 3h7v7H3zm11 0h7v7h-7zm0 11h7v7h-7zM3 14h7v7H3z',
};

const ADMIN_NAV = [
  { label: 'Dashboard',    icon: 'dashboard',   to: '/admin',              exact: true },
  { label: 'Exams',        icon: 'exams',       to: '/admin/exams' },
  { label: 'Question Bank', icon: 'questionBank', to: '/admin/question-bank' },
  { label: 'Blueprints',    icon: 'blueprint',    to: '/admin/blueprints' },
